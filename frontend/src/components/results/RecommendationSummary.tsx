    ...
    <div className="recommendation-summary">
      <div className="summary-header">
        ...
        <p className="summary-description">
          {(t('results.summaryDescription') || 'Based on your profile, we\'ve identified {{count}} career paths that align with your interests and goals.').replace('{{count}}', recommendations.length.toString())}
        </p>
      </div>
